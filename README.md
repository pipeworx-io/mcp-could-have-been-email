...
`tools/list` at `https://gateway.pipeworx.io/could-have-been-email/mcp` returns the tools in the table
...
```json
{
  "mcpServers": {
    "could-have-been-email": {
      "command": "npx",
      "args": ["-y", "@pipeworx/mcp-could-have-been-email"]
    }
  }
}
```
...
```bash
npx -y @pipeworx/mcp-could-have-been-email
```
